    ...
    <div className="grid lg:grid-cols-2 gap-7 lg:mt-10">
        <div className="left_side">
            <p className="px-8 pb-5 lg:text-left text-center">
                <div className="p-7" >
                    It is a long established fact that a reader for hell in a cell will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal it look like readable English. Many desktop publishing packages and web page editors now use Various versions have evolved over the years, sometimes by accident.
